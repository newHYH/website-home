        ...
        <div class="param-list">
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-4">
                    ...
                    <p>玻璃板：9.1mm;素皮版：9.5mm</p>
                </li>
                <li class="col-sm-12 col-md-6 col-lg-4">
                    <p class="bold-text">重量</p>
                    <p>玻璃板：约212克（含电池）；素皮版：约212克（含电池）</p>
            ...
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-4">
                    ...
                    <p>6.76英寸</p>
                    <p class="gray-text">*显示屏采用圆角设计，按照标准矩形测量时，屏幕对角线长度是6.76英寸（实际可视区域略小）。</p>
                    <p class="bold-text">类型</p>
                    <p>OLED,最高支持90Hz刷新率、240Hz触控采样率。</p>
                    <p class="bold-text">色彩</p>
                    <p>1679万色，DCI-P3广色域</p>
                </li>
                <li class="col-sm-12 col-md-6 col-lg-4">
            ...
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    ...
                    <p>八核，1 x Cortex-A77@3.13 GHz + 3 x Cortex-A77@2.54 GHz + 4 x Cortex-A55@2.05 GHz</p>
            ...
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    ...
                    <p>8GB RAM+128/256/512GB ROM</p>
                    <p class="gray-text">*可使用的内存容量小于次值，因为手机软件占用的空间。</p>
                </li>
            </ul>
            <div class="gray-line"></div>
            <ul class="row">
            ...
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    ...
                    <p>最大可支持 3840 x 2160 像素，支持 1080p@240 fps 慢动作视频</p>
            ...
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    <p class="bold-gray-text">4400 mAh（典型值）</p>
                    <p class="gray-text">*电池额定容量为 4300 mAh。</p>
            ...
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    <p class="bold-gray-text">有线充电：手机支持最大超级快充 11V/6A，兼容 10V/4A 或 10V/2.25A 或 4.5V/5A 或 5V/4.5A 超级快充，兼容 9V/2A 快充。</p>
            ...
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    ...
                    <p>2.4 GHz 和 5 GHz 802.11 a/b/g/n/ac/ax，2x2 MIMO，HE160，1024 QAM，8 Spatial-stream Sounding MU-MIMO</p>
            ...
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    <p class="bold-gray-text">支持 GPS (L1 + L5 双频) / AGPS / GLONASS/ 北斗 (B1I+B1C+B2a+B2b 四频) / GALILEO (E1 + E5a + E5b 三频) / QZSS (L1 + L5 双频) / NavIC</p>
                </li>
            </ul>
            <div class="gray-line"></div>
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    <p class="bold-gray-text">姿态感应器</p>
                    <p class="bold-gray-text">3D</p>
                    <p class="bold-gray-text">人脸识别</p>
                    <p class="bold-gray-text">重力传感器</p>
                    <p class="bold-gray-text">红外传感器</p>
                    <p class="bold-gray-text">屏内指纹</p>
                    <p class="bold-gray-text">气压计</p>
                    <p class="bold-gray-text">陀螺仪</p>
                    <p class="bold-gray-text">指南针</p>
                    <p class="bold-gray-text">环境光传感器</p>
                    <p class="bold-gray-text">接近传感器</p>
                    <p class="bold-gray-text">色温传感器</p>
                    <p class="bold-gray-text">Camera</p>
                    <p class="bold-gray-text">激光对焦传感器</p>
                </li>
            </ul>
            <div class="gray-line"></div>
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    ...
                    <p class="gray-text"> Histen，支持立体声音效</p>
                    <p class="gray-text">*.mp3、*.mp4、*.3gp、*.ogg、*.amr、*.aac、*.flac、*.wav、*.midi</p>
            ...
            <ul class="row">
                ...
                <li class="col-sm-12 col-md-12 col-lg-8">
                    <p>外包装采用塑封，彩盒内标配：</p>
                    <p>手机（含内置电池） x 1</p>
                    <p>华为 SuperCharge 充电器 x 1</p>
                    <p>USB Type-C 数据线 x 1</p>
                    <p>USB Type-C 数字耳机 x 1</p>
                    <p>超薄保护软壳 x 1</p>
                    <p>快速指南 x 1</p>
                    <p>取卡针 x 1</p>
                    <p>三包凭证 x 1</p>
