<template>
    <div class="product2">
        ...
        <div class="img-wrap img2" ref="img1">
            <img src="../assets/product2/fang_c.png" alt="" class="opcity animate__animated" :class="isScroll1?'animate__fadeInLeft':''">
...
export default {
    ...
    methods: {
        ...
        handelScroll(e) {
            let top1 = this.$refs.img1.offsetTop -350
