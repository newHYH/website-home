const proList = [{
    ...
    },
    {
        ...
        con:'<p class="b-t">问题现象：</p>照片上物体有紫边，在超广角模式下会更加明显。<p class="b-t">问题原因：</p>当被拍摄物体与背景亮度反差比较大时（如逆光条件），在高光与低光部位交界处会出现色斑现象，与相机镜头的色散等有关。（紫边现象）<br/>光线的色散相对严重。所以超广角镜头相对于普通广角镜头拍照时，紫边效应会明显一些，是超广角镜头的光学特性。'
    },
    {
    ...
    },
    {
        ...
        con:'<p class="b-t">问题原因：</p>由于4K录像功耗较大，超过10分钟会导致手机过热，有损坏手机其他零器件的风险，所以我们对4K录像时长做了限制，一次拍摄不超过10分钟。'
    },
    {
